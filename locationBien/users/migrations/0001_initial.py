    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_facultative_4', models.ImageField(blank=True, null=True, upload_to='biens_photos/')),
                ('etat', models.CharField(choices=[('disponible', 'Disponible'), ('non_disponible', 'Non disponible')], default='disponible', max_length=20)),
